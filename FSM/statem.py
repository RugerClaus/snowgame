...
class StateManager:
    ...
    def __init__(self):
        ...
        self.allowed_transitions = {
            APPSTATE.MAIN_MENU: [APPSTATE.ENDLESS,APPSTATE.TUTORIAL,APPSTATE.TIMED,APPSTATE.QUIT_APP],
            ...
            APPSTATE.TIMED: [APPSTATE.MAIN_MENU,APPSTATE.PAUSED,APPSTATE.GAME_OVER,APPSTATE.QUIT_APP],
            APPSTATE.PAUSED: [APPSTATE.ENDLESS,APPSTATE.TUTORIAL,APPSTATE.TIMED,APPSTATE.MAIN_MENU,APPSTATE.QUIT_APP],
