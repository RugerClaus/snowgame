...
class MainMenu:
    def __init__(self, screen, endless_game, timed, tutorial, quit_callback):
        self.screen = screen
    ...
    def create_buttons(self):
        ...
        self.buttons = [
            ...
            Button("Timed Mode", center_x, start_y + spacing * 1, btn_width + 80, btn_height, (255, 255, 255), (128, 0, 200), self.timed),
